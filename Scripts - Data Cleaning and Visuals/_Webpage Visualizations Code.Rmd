...
```{r R Define Directories and Read/Clean CSVs}
# Load Directories
...
# Load the datasets
all_threads <- read.csv(file.path(threads_directory, "combined_threads_cleaned.csv"))
all_comments <- read.csv(file.path(comments_directory, "combined_comments_cleaned.csv"))
...
```{python Python Define Directories and Read CSVs}
# Define directories
output_directory = "/Users/emerson/Github/usenet_AIDs_discourses_webpage/"
threads_directory = "/Users/emerson/Github/usenet_AIDs_discourses_webpage/CSV Files/Threads/"
comments_directory = "/Users/emerson/Github/usenet_AIDs_discourses_webpage/CSV Files/Comments/"
...
all_threads = pd.read_csv(os.path.join(threads_directory, "threads_cleaned_82TO89.csv"))
all_comments = pd.read_csv(os.path.join(comments_directory, "comments_cleaned_82TO89.csv"))
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/distribution_of_comments_per_newsgroup.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/number_of_threads_over_time.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/average_comments_per_thread_by_newsgroup.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/sentiment_score_distribution_across_all_comments.png"))
plt.show()
```
...
# Save the figure
plt.savefig(os.path.join(output_directory, "images and tables/top_25_most_active_users_by_newsgroup.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/combined_daily_activity_heatmap.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/word_cloud_all_comments.png"))
plt.show()
...
for newsgroup in all_comments['newsgroup'].unique():
    ...
    plt.savefig(os.path.join(output_directory, f"images and tables/word_cloud_{newsgroup}.png"))
    plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/growth_of_newsgroups_over_time.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/author_engagement_scatterplot.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/sentiment_over_time.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/sentiment_distribution_by_newsgroup.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/monthly_sentiment_heatmap.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/sentiment_over_time_by_newsgroup.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/sentiment_polarity_distribution.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/sentiment_trend_rolling_average.png"))
plt.show()
```
...
plt.tight_layout()
0_output_path = os.path.join(output_directory, "images and tables/word_cloud_positive_sentiment.png"))
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/word_cloud_negative_sentiment.png"))
plt.show()
```
...
network_graph_path <- file.path(output_directory, "images and tables/network_graph.html")
