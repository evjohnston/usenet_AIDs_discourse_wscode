...
# Load the datasets
all_threads <- read.csv("CSV Files/Threads/combined_threads_cleaned.csv")
all_comments <- read.csv("CSV Files/Comments/combined_comments_cleaned.csv")
...
all_comments = pd.read_csv("CSV Files/Comments/comments_cleaned_82TO89.csv")
all_threads = pd.read_csv("CSV Files/Threads/threads_cleaned_82TO89.csv")
```
...
plt.tight_layout()
plt.savefig('images and tables/distribution_of_comments_per_newsgroup.png')
plt.show()
```
...
plt.tight_layout()
plt.savefig('images and tables/number_of_threads_over_time.png')
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('images and tables/average_comments_per_thread_by_newsgroup.png')
plt.show()
```
...
plt.tight_layout()
plt.savefig('images and tables/sentiment_score_distribution_across_all_comments.png')
plt.show()
```
...
# Save the figure
plt.savefig('images and tables/top_25_most_active_users_by_newsgroup.png')
plt.show()
```
...
plt.tight_layout()
plt.savefig('images and tables/combined_daily_activity_heatmap.png')
plt.show()
```
...
plt.tight_layout()
plt.savefig('images and tables/word_cloud_all_comments.png')
plt.show()
...
for newsgroup in all_comments['newsgroup'].unique():
    ...
    plt.tight_layout()
    plt.savefig(f'images and tables/word_cloud_{newsgroup}.png')
    plt.show()
```
...
plt.tight_layout()
plt.savefig('images and tables/growth_of_newsgroups_over_time.png')
plt.show()
```
...
plt.tight_layout()
plt.savefig('images and tables/author_engagement_scatterplot.png')
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('images and tables/sentiment_over_time.png')
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('images and tables/sentiment_distribution_by_newsgroup.png')
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('images and tables/monthly_sentiment_heatmap.png')
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('images and tables/sentiment_over_time_by_newsgroup.png')
plt.show()
```
...
plt.tight_layout()
plt.savefig('images and tables/sentiment_polarity_distribution.png')
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('images and tables/sentiment_trend_rolling_average.png')
plt.show()
```
...
plt.tight_layout()
plt.savefig('images and tables/word_cloud_positive_sentiment.png')
plt.show()
...
plt.tight_layout()
plt.savefig('images and tables/word_cloud_negative_sentiment.png')
plt.show()
```
...
visSave(network_graph, file = "Images and Tables/network_graph.html")
...
html_file <- "Images and Tables/network_graph.html"
