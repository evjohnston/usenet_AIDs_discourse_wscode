...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/old web visualizations/distribution_of_comments_per_newsgroup.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/number_of_threads_over_time.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/average_comments_per_thread_by_newsgroup.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/sentiment_score_distribution_across_all_comments.png"))
plt.show()
```
...
# Save the figure
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/top_25_most_active_users_by_newsgroup.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/combined_daily_activity_heatmap.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/word_cloud_all_comments.png"))
plt.show()
...
for newsgroup in all_comments['newsgroup'].unique():
    ...
    # Use f-string to save the file with the specific newsgroup name
    plt.savefig(os.path.join(output_directory, f"images and tables/old web visualizations/word_cloud_{newsgroup}.png"))
    plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/growth_of_newsgroups_over_time.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/author_engagement_scatterplot.png"))
plt.show()
```

# Sentiment Visualizations - Python
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/sentiment_over_time.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/sentiment_distribution_by_newsgroup.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/monthly_sentiment_heatmap.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/sentiment_over_time_by_newsgroup.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/sentiment_polarity_distribution.png"))
plt.show()
```
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/sentiment_trend_rolling_average.png"))
plt.show()
```
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/word_cloud_positive_sentiment.png"))
...
plt.tight_layout()
plt.savefig(os.path.join(output_directory, "images and tables/old web visualizations/word_cloud_negative_sentiment.png"))
plt.show()
```


# Network Visualizations - R
...
network_graph_path <- file.path(output_directory, "images and tables/old web visualizations/network_graph.html")
visSave(network_graph, file = network_graph_path)
