...
# tab_df(transposed_best_matches, file = output_file_path_transposed)
```
...
# ggsave(file.path(output_directory, "images and tables", "plot_topic_influence_comparison_bar_graph.png"), width = 10, height = 6, dpi = 300)
```
